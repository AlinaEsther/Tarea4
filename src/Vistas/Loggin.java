...
public class Loggin extends JFrame {
	...
	public Loggin() {
		...
		bntsesion.setForeground(Color.BLUE);
		bntsesion.setBackground(Color.WHITE);
	...
	void iniciarsesision(){
    	...
    	if (!clave.equals("") && !usuario.equals("")) {
    		...
    		try {
    			...
    			if (condicion) {
    				JOptionPane.showMessageDialog(null, "Debe ingresar su usuario y contrase�a, si no est� registrado debe registrarse.");
    				txtpasswd.setText("");
    				txtusuario.setText("");
